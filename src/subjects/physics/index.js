// Physics & Math — authored chapter modules (chNN.js).
// NOTE: the Physics PDF renders A/B/C/D answer labels as glyphs that don't survive text
// extraction, so the book's discrete practice questions are not yet captured (empty Practice
// tab). Content (12 chapters) is complete; questions are a follow-up extraction pass.
